    ...
    <div className="flex relative bg-main-bg">
      ...
      >
        ...
        <main className="pt-[22px] pb-[38px] max-[1024px]:px-[32px] max-[768px]:px-[16px]">
          ...
          <FormGraphics isFavourite={true} selectedField={selectedField} setSelectedField={setSelectedField} />
          {tableDisplay ? (
            <Table />
          ) : (
            <GraphBlock isFavourite={true} selectedField={selectedField} setSelectedField={setSelectedField} />
          )}
        </main>
      </div>
    </div>
